...
public class MinimalFunctionalRouteAlgorithmTaskFactory
    ...
    public MinimalFunctionalRouteAlgorithmTaskFactory (RunnerTask runnerTask,
    ...
    public TaskIterator createTaskIterator () {
        ...
        tasks.append(new MinimalFunctionalRouteAlgorithmTask(runnerTask, contextBundle, resultsBundle, algStep));
        return tasks;
    }
}