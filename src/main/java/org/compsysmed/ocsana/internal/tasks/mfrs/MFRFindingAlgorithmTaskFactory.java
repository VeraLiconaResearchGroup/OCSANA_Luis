...
public class MFRFindingAlgorithmTaskFactory
    ...
    public  MFRFindingAlgorithmTaskFactory (RunnerTask runnerTask,
    ...
    public TaskIterator createTaskIterator () {
        ...
        tasks.append(new MFRFindingAlgorithmTask(runnerTask, contextBundle, resultsBundle, algStep));
        return tasks;
    }
}
